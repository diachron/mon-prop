 ...
 *
 */
public class RDFStoreConnection {
	static final String monpropNamedGraph = "http://www.diachron-fp7.eu/monprop";
	...
	private static final String DEFAULT_HOST = "diachron.imis.athena-innovation.gr";
	private static final int DEFAULT_PORT = 10011;
	...
	private static final Logger logger = LoggerFactory.getLogger(RDFStoreConnection.class);


	private RDFStoreConnection() {
	...
	public static void init() {
		try {
			if (!isInitialized()) {
				...
				InputStream input = RDFStoreConnection.class.getClassLoader().getResourceAsStream("virt-connection.properties");
	...
	*/
	...
	public static Model getJenaModel(){
		return new VirtModel(new VirtGraph (monpropNamedGraph,vDatasource));
	}
